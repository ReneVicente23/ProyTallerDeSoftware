...
public interface UsuarioDAO {
    ...
    @Insert("INSERT INTO usuarios(googleid, usertype, family_name, given_name, hd, email) VALUES (#{googleid}, #{usertype}, #{family_name}, #{given_name}, #{hd}, #{email})")
    public void saveUsuario(@Param("googleid") Integer googleid, @Param("usertype") Integer usertype,@Param("family_name") String family_name, @Param("given_name") String given_name, @Param("hd") String hd, @Param("email") String email);
}
